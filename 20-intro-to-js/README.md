...
Three important abilities of JS:
1. Allow us to send requests while the page is loaded
2. Allow us to capture user interaction
3. Allow us to add stuff to the page (DOM)

Data Type vs Structure
- Data type -> representation of information
- Data structure holds data types
- Data structure is a *collection* of data types

1. Hash
  - Information is stored using key-value pairs
  - Unordered
  - Represent distinct objects with similar values
  - Represent things as a collection of properties
2. Array
  - Ordered
  - Access information by index
  - Lists of things that are of the same type
